...
class IconsCls(Frame):
    ...
    # Tarea: - Activa el evento '<Motion>', cuando se mapea la interface global
    ...
    #------------------------------------- 1 ------------------------------------------ Eventos: '<ButtonPress>' - '<ButtonRelease>'
    ...
    #    método   ==>  def. motion_open_interface_vertical()
